...
## Udacity data analysis professional track 1st project
### Bike Share Data
...
Gender
Birth Year
![image](https://user-images.githubusercontent.com/105181984/209271760-161058e7-97a8-4cae-85b0-1e1bfb844d57.png)

Data for the first 10 rides in the new_york_city.csv file

The files had more columns and they differed in format in many cases. Some data wrangling has been performed to condense these files to the above core six columns to make your analysis and the evaluation of your Python skills more straightforward.
